...
<form action="fiche_action.php" method="post">
<h1>fiche :</h1>
  <div class="form-group">
    <label for="idM">idM :</label>
    <input type="text" class="form-control" id="idM" name="idM" placeholder="Entrez le prenom">
  </div>
  <div class="form-group">
    <label for="idP">idP :</label>
    <input name="idP"  id="idP" class="form-control" placeholder="Enter l'age">
  </div>
  <div class="form-row">
