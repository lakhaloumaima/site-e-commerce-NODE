...
<div class="row">
    <div class="col-md-6 col-md-offset-1" id="login">
        <img src="img.png"  style="width:20%" > 
            ...
            <h1><marquee> bienvenue </marquee></h1><br>
                <div class="row">
                        ...
                        <form class="box" >
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                             <br><br>
                                ...
                                <div class="col-md-6 col-md-offset-3" id="login">
                                <a href='ajout_maladie.php' class="btn btn-info" >Ajouter maladie</a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
                                <a href='ajout_fiche.php' class="btn btn-info" >Ajouter une fiche</a>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
