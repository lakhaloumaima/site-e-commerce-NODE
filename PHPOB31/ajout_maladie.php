...
<form action="ajout_maladie_action.php" method="post">
<h1>Ajout le maladie du patient :</h1>
  <div class="form-group">
    <label for="NomSym">NomSym :</label>
    <input type="text" class="form-control" id="nomSym" name="nomSym" placeholder="Entrez le nomSym">
  </div>
  <div class="form-group">
    <label for="DescSym">DescSym :</label>
    <input name="descSym"  id="descSym" class="form-control" placeholder="Entrer le descSym">
  </div>
  <div class="form-group">
    <label for="Ordonance">Ordonance :</label>
    <input type="text" class="form-control" name="ordonance" id="ordonance" placeholder="Entrer l'ordonance"> 
  </div>
